...
You might get an error regarding package `libjson-rpc-cpp-dev`. That package was renamed to `libjsonrpccpp-dev` in Ubuntu 15.10+. Just replace the package name in the `apt-get install ...` line.
